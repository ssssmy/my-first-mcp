...
const HEWEATHER_API_KEY = "your_token"; // TODO: 替换为你的KEY
const HEWEATHER_API_BASE = "https://your_api_host/v7/weather/now";
const HEWEATHER_GEO_API = "https://your_api_host/geo/v2/city/lookup";
...
// 根据城市名获取locationId
async function getLocationId(city: string) {
...
// 获取实时天气
async function fetchWeatherNow(locationId: string) {
